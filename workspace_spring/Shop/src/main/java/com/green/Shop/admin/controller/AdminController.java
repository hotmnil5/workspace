...
import com.green.Shop.utill.FileUploadUtill;
...
public class AdminController {
    ...
    //상품 등록
    //첨부파일이 포함된 데이터가 전달 되면 자바에서 데이터를 받는 문법도 달라짐
    ...
    public void insertItem(ItemVO itemVO,
        ...
        ImgVO mainImgVO = FileUploadUtill.fileUpload(mainImg);
        mainImgVO.setIsMain("Y");
        // 서브가 되는 이미지 첨부 후 첨부된 원본 파일명, 첨부된 파일명을 리턴 받음
        ImgVO subImgVO = FileUploadUtill.fileUpload(subImg);
