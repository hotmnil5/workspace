...
public class FileUploadUtill {
    ...
    public static ImgVO fileUpload(MultipartFile uploadFile){
        ...
        if(!uploadFile.isEmpty()){
            ...
            //첨부될 파일명
            String attachendFilename = uuid + extension;

            //첨부될 파일 생성
            File file = new File(uploadPath + attachendFilename);
            ...
            try {
                ...
                imgVO.setAttachedFileName(attachendFilename);
