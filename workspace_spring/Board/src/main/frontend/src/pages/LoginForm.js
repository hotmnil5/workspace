...
const LoginForm = ({setLoginInfo}) => {
  ...
  const data = window.sessionStorage.getItem('mamber');
  console.log(data);
  ...
  // 객체나 배열을 Storage에 저장할 대 json 형태로 저장할 수 있음.
